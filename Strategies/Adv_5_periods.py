...
'GeneralConfig' : {
    "name": "Adv_BullishTargets_5_periods",
    "buy_threshold": 5,
    "sell_threshold": -3,
    "interval": "1d",
    "period": "730d"
...
'EntryConfig' : {
    ...
    "indicators": [
        ...
        {"type":"rangeMinus", "field1": "BBNeck%", "field2": 5, "period": 1, "color": 3, "score": 6},
    ],
	"confirmations": [
        ...
        {'type':'rising','field':'obv','period':5, 'color':2,'score':3},
        {'type':'rising','field':'RSI','period':5, 'color':2, 'score':2},
        ...
        {"type":"rangeMinus", "field1": "BBNeck%", "field2": 10, "period": 1, "color": 2, "score": 3},
	]
},
...
'ExitConfig' : {
    ...
    "indicators": [
        ...
        {"type":"rangeMinus", "field1": "RSI", "field2": 40, "period": 5, "color": -2, "score": 4},
        {"type":"rangeMinus", "field1": "RSI", "field2": 40, "period": 13, "color": -3, "score": 6},
	...
	"confirmations": [
        {"type":"hasMaxima","field":"macd_histogram","period":3,"color": -3,"score": 4},
        {"type":"rangeMinus", "field1": "BBNeck%", "field2": 5, "period": 1, "color": -3, "score": 4},
		{"type":"lastCrossOver", "field1": "StochRSISlow", "field2": "StochRSIFast", "period": 3, "color": -1, "score": 2},
        ...
        # {"type":"rising", "field": "EMA13","period": 10, "color": -1, "score": 2},
        {"type":"falling", "field": "EMA13","period": 5, "color": -2, "score": 2},
        {"type":"falling", "field": "EMA13","period": 13, "color": -2, "score": 3},
